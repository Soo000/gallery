...
@Component
@Aspect
public class ProductCtrlAop extends MethodRunLogAop {
	
	//private Logger logger = Logger.getLogger(this.getClass());

	@Override
	@Before("execution(* com.kkwrite.gallery.ctrl.prodetails.ProdetailsCtrl.*(..))")
	...
	@Override
	@After("execution(* com.kkwrite.gallery.ctrl.prodetails.ProdetailsCtrl.*(..))")
